  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <nav className="relative z-20 flex items-center justify-between px-6 md:px-12 py-6 max-w-7xl mx-auto">
        ...
        <button onClick={onStart} className="lp-btn-primary text-sm px-4 py-2 rounded-lg">Get started</button>
      </nav>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 pt-10 md:pt-16 pb-28 grid md:grid-cols-2 gap-14 items-center">
        <div className="lp-fade-up">
          ...
          <div className="mt-9 flex flex-wrap items-center gap-4">
            ...
            <button onClick={onExplore} className="lp-btn-ghost px-6 py-3.5 rounded-xl text-[15px] text-slate-200">
              Explore platform
            </button>
          </div>
...
function TopBar({ title, onProfileClick }) {
  return (
    <div className="flex items-center justify-between pl-36 sm:pl-40 pr-5 md:pr-8 py-5 sticky top-0 z-20" style={{ background: "rgba(6,9,17,0.7)", backdropFilter: "blur(16px)", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
      ...
      <div className="flex items-center gap-3">
        ...
        <button onClick={onProfileClick} className="w-9 h-9 rounded-full flex items-center justify-center text-sm font-semibold shrink-0" style={{ background: "linear-gradient(135deg,#22d3ee,#8b5cf6)", color: "#04121a" }}>
          A
        </button>
      </div>
    </div>
...
function ProfileView() {
  ...
  if (showAssessment) {
    return (
      <div className="space-y-6">
        <button onClick={() => setShowAssessment(false)} className="flex items-center gap-1.5 text-sm" style={{ color: "var(--text-dim)" }}>
    ...
    <div className="space-y-6">
      ...
      <GlassCard className="p-6" hover>
        <div className="flex items-center justify-between flex-wrap gap-3 mb-4">
          ...
          <button onClick={() => setShowAssessment(true)} className="lp-btn-primary px-4 py-2 rounded-lg text-sm">Take new assessment</button>
        </div>
