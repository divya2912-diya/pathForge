...
export function LanguageSelector({ currentLang = "en", onLanguageChange, compact = false }) {
  ...
  return (
    <div ref={containerRef} className="relative inline-block text-left z-40">
      ...
      {open && (
        <div className="absolute right-0 mt-2 w-44 rounded-2xl bg-[#09101f] border border-cyan-500/30 shadow-2xl p-1.5 z-50 animate-in fade-in slide-in-from-top-2 duration-200">
