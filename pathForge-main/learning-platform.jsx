...
function LandingPage({ onStart, onExplore, onProfile, student }) {
  return (
      ...
      <div className="w-full max-w-xl lp-glass-strong rounded-2xl border border-white/10 shadow-2xl overflow-hidden max-h-[90vh] flex flex-col">
        ...
        <div className="flex items-center justify-between px-6 py-4" style={{ borderBottom: "1px solid rgba(255,255,255,0.08)" }}>
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="lp-display text-base font-semibold">Edit Profile</h3>
...
function ProfileView({ student = STUDENT, onUpdateStudent }) {
